...
SELECT SUM(total_payment) AS PMTD_Total_Amount_Recevied FROM bank_loan_data
WHERE MONTH(issue_date) = 11 AND YEAR(issue_date)= 2021

-- Average Interest Rate
SELECT AVG(int_rate) AS Avg_Intrest_Rate FROM bank_loan_data

-- Percentage Of Avg Interest Rate
SELECT ROUND(AVG(int_rate)*100,2) AS Pct_Intrest_Rate FROM bank_loan_data

-- MTD Average Interest
SELECT ROUND(AVG(int_rate)*100,2) AS MTD_Avg_Intrest_Rate FROM bank_loan_data
WHERE MONTH(issue_date) = 12 AND YEAR(issue_date)= 2021

-- PMTD Average Interest
SELECT ROUND(AVG(int_rate)*100,2) AS PMTD_Avg_Intrest_Rate FROM bank_loan_data
WHERE MONTH(issue_date) = 11 AND YEAR(issue_date)= 2021
...
-- HOME OWNERSHIP BY GRADE AND ADDRESS STATE
SELECT 
	home_ownership AS Home_Ownership, 
	COUNT(id) AS Total_Loan_Applications,
	SUM(loan_amount) AS Total_Funded_Amount,
